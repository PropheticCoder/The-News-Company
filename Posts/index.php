...
include('../inc/requests/getAllArticlesRequest.php');
include('../inc/requests/getCategoryAndSubCategoriesRequest.php');
include('../inc/requests/searchArticleByCategory.php');
include('../inc/requests/searchArticleByDate.php');
?>
...
<head>
    ...
    <title>News Company | Portal</title>
...
<body style="background: rgb(255,255,255);">
            ...
            <div class="container"><a class="navbar-brand" href="#"><img id="logo" class="logo"
                ...
                <div class="collapse navbar-collapse" id="navcol-1" style="border-radius: 12px;">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link"
                                href="new_article/?token=<?= $_GET['token'] ?>&portal=<?= $_GET['portal'] ?>&articleFilter=<?= $_GET['articleFilter'] ?>"
    ...
    <section id="breaking-news" class="breaking-news" style="margin: auto;width: 90%;margin-bottom: 21%;padding: 2%;">
        <h1 id="admin-heading" style="font-size: 100%;text-align: center;"><strong><?= ucfirst($loggedInName) ?>'s
                articles
                :
        ...
        <div id="formResponse"
            style="margin:auto;background: #ff0000;border-radius: 7px;font-size: 11px;text-align:center;width:300px">
