...
<?php include('../../inc/requests/loginRequest.php') ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="main" style="width: 100%;">
        <div id="loginFormMain"
            ...
            <form style="text-align: left;" method="post" action="">
                ...
                <div id="loginPageLinks" style="width: 100%;text-align: center;">
                    <a class="d-inline-block" href="../../Posts/register/"
                        style="font-size: 13px;margin-left: 10px;">Create
                        account?<br></a>
                    <a class="d-inline-block" id="forgot-passwordlink" href="#" style="font-size: 13px;">Forgot
                        password?<br>
                        <a class="d-inline-block" id="forgot-passwordlink" href="../../Admin/login/"
                            style="font-size: 13px;">I am
                            an
                            administrator<br><br>
                        </a>
                </div>
